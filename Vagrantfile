...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "joelwill-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/awstraining"
  #   chef.validation_client_name = "awstraining-validator"
  #   chef.validation_key_path = ".chef/awstraining-validator.pem"
  # end
end
